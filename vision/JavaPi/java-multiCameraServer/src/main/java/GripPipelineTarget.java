...
/**
* GripPipelineTarget class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class GripPipelineTarget implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {55.03597122302158, 152.72727272727272};
		double[] hsvThresholdSaturation = {185.74640287769785, 255.0};
		double[] hsvThresholdValue = {195.0, 255.0};
